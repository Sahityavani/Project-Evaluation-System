<?php
include('auth.php');
$title = "Admin | Add/Edit MRG Evaluators";
include('../head.php');
include('../db.php');
...
<body>
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Add MRG Evaluators</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Add MRG Evaluator Form -->
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Add MRG Evaluator</h4>
                        </div>
                        <div class="card-body">
                            <form id="addEvaluatorForm" method="post" action="add_mrgevaluator.php">
                                <div class="mb-3">
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Existing MRG Evaluators</h4>
                        </div>
                        <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="editEvaluatorForm" method="post" action="edit_mrgevaluator.php">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.edit-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            fetch('get_mrgevaluator_details.php', {
                method: 'POST',
                headers: {
