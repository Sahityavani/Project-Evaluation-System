...
$batchesQuery = "
    SELECT b.batch_id, b.batch_name, b.batch_title, IFNULL(s.name, 'Not Allocated') AS supervisor_name
    FROM batches b
    LEFT JOIN supervisors s ON b.supervisor = s.username
";
$batchesResult = $conn->query($batchesQuery);

// Fetch members for a specific batch
$members = [];
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Batches</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php while ($batch = $batchesResult->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($batch['supervisor_name']); ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-primary view-members-btn" data-id="<?php echo $batch['batch_id']; ?>">View Members</button>
                                                    <button type="button" class="btn btn-secondary generate-pdf-btn" data-id="<?php echo $batch['batch_id']; ?>">Generate PDF</button>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
                    ...
                    <div id="members-container" class="mt-4" style="display: none;">
                        ...
                        <!-- Members table will be dynamically inserted here -->
                    </div>
                </div>
            </div>
            ...
            <style>
            /* Custom Styles for Members Table */
