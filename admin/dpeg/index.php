...
include('auth.php');
include('../db.php');
$title = "DPEG Evaluator Dashboard";
include('../head.php');

$username = $conn->real_escape_string($_SESSION['user']);
$sql = "SELECT * FROM dept_evaluators WHERE username = '$username'";
...
$sql2 = "
        SELECT b.*
        FROM batches b
        INNER JOIN dpeg_batches mb ON b.batch_id = mb.batch_id
        INNER JOIN dpeg_evaluators me ON mb.dpeg_id = me.dpeg_id
        INNER JOIN dept_evaluators e ON me.evaluator_id = e.evaluator_id
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="listjs-table" id="managerList">
                                                    <div class="card-header">
                                                        <h4 class="card-title mb-0"> <img width="40" style="margin-right: 5px;" height="40" src="https://img.icons8.com/color/48/admin-settings-male.png" alt="admin-settings-male" />MRG Evaluators List</h4>
                                                    </div><!-- end card header -->
