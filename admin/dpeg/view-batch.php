...
// Fetch batches with students and their DPEG details for the current evaluator
$batchesQuery = "
    SELECT 
        b.batch_id, 
        b.batch_name, 
    ...
    LEFT JOIN 
        dpeg m ON b.dpeg_id = m.dpeg_id
    LEFT JOIN 
        dpeg_evaluators me ON m.dpeg_id = me.dpeg_id
    LEFT JOIN 
        dept_evaluators e ON me.evaluator_id = e.evaluator_id
    WHERE 
        e.username = ?
    GROUP BY 
        b.batch_id, m.dpeg_name
";
