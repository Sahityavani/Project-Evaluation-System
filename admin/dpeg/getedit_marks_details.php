...
$sql = "SELECT evaluator_id FROM dpeg_evaluators WHERE username = ?";
...
// Fetch current marks and sub_parts details from dpeg_evaluations
$sql_marks = "
...
$stmt_marks->bind_param('ii', $evaluation_type, $batch_id, $evaluator_id);
$stmt_marks->execute();
