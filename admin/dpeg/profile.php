                            ...
                            <div class="col">
                                <div class="p-2">
                                    ...
                                    <div class="hstack text-white-50 gap-1">
                                        <div class="me-2">You are a DEPG Evaluator you can add,modify and award marks to batches of students.</div>
                                    </div>
                                </div>
                            </div>
                            <!--end col-->
                                            ...
                                            <div class="col-xxl-9">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p>✅ Able to edit batches.</p>
                                                        <p>✅ Able to add or modify students.</p>
                                                        <p>✅ Able to view batche students.</p>
                                                        <p>✅ Able to award marks for batch students.</p>
                                                        <div class="row">
