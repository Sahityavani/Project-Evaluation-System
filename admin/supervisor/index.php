...
$sql2 = "SELECT * FROM students WHERE supervisor ='$username'";
$studentsearch = $conn->query($sql2);
                                            ...
                                            <div class="card-body">
                                                <div class="listjs-table" id="supervisorList">
                                                    <div class="card-header">
                                                        <h4 class="card-title mb-0"><img width="40" height="40" src="https://img.icons8.com/3d-fluency/94/layers.png" alt="external-supervisor-character-icons-flaticons-flat-flat-icons" /> Your Batch List</h4>
                                                    </div><!-- end card header -->
                                                    ...
                                                    <div class="table-responsive table-card mt-3 mb-1">
                                                        <table class="table align-middle table-nowrap" id="supervisorTable">
                                                            ...
                                                            <tbody class="list form-check-all">
                                                                <?php while ($student = $studentsearch->fetch_assoc()) : ?>
                                                                    <tr>
                                                                        <td class="customer_name"><b><?php echo htmlspecialchars($student['name']); ?></b></td>
                                                                        <td class="customer_name"><b><?php echo htmlspecialchars($student['rollno']); ?></b></td>
