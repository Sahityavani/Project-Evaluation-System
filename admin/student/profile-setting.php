                                        ...
                                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                            <form action="../change.php" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">RollNo (Unable to Change)</label>
                                                            <input type="text" class="form-control" id="firstnameInput" name="username" placeholder="Enter your Name" value="<?php echo $username;?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
