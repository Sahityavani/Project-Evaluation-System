...
if ($result->num_rows > 0) {
    ...
    // Get Batch Details directly from MRG Evaluations
    $sql = "
        SELECT b.*, m.mrg_name, GROUP_CONCAT(DISTINCT e.name SEPARATOR ', ') AS evaluators 
        FROM mrg_evaluations me
        JOIN batches b ON me.batch_id = b.batch_id
        LEFT JOIN mrg m ON b.mrg_id = m.mrg_id
        LEFT JOIN mrg_evaluators mre ON m.mrg_id = mre.mrg_id
        LEFT JOIN evaluators e ON mre.evaluator_id = e.evaluator_id
